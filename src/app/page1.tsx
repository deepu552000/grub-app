...
// We only have 3 real expressions per stage (happy/angry/sleepy), so smug and
// hungry borrow the closest existing mood for now - see the design note in
// the project notes for why (smug ~ happy, hungry ~ angry are close enough
// substitutes until dedicated art exists).
...
function Kitty({
  ...
  return (
    ...
    >
      ...
      {/* key={src} forces React to remount the img on stage/mood change, which is
          what lets the CSS crossfade animation (kittyFadeIn) replay each time. */}
